      ...
      <form onSubmit={handleSubmit} className="glass-card p-6 lg:p-8 border border-slate-800 space-y-6 text-xs shadow-2xl">
        ...
        <div className="space-y-3">
          <button
            ...
            className={`px-3.5 py-2 rounded-xl border text-xs font-semibold transition-all inline-flex items-center gap-2 ${
              hasBlocker
          ...
          {hasBlocker && (
            <div className="p-4 rounded-xl bg-rose-950/20 border border-rose-800/40 space-y-3 animate-in fade-in">
              <div>
                <label className="font-semibold text-rose-200 block mb-1">
                  Blocker Description
                </label>
                <input
                  type="text"
                  ...
                  placeholder="e.g. Waiting on staging database access credentials"
                  className="w-full px-3 py-2 bg-slate-900 border border-rose-800/60 rounded-lg text-white placeholder-slate-500 focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Need Renuka to request IAM elevation"
                  className="w-full px-3 py-2 bg-slate-900 border border-rose-800/60 rounded-lg text-white placeholder-slate-500 focus:outline-none"
                />
              </div>
            </div>
