      ...
      <div className="glass-card p-6 border border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-300 mt-0.5">
            Asynchronous daily coordination feed across Maple Learning Solutions.
          </p>
        </div>
      ...
      <div className="space-y-4">
        {filteredUpdates.length === 0 ? (
          ...
          filteredUpdates.map((u) => (
            ...
            >
              {/* DailyBot Card Header */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800/80">
                <div className="flex items-center gap-3">
                  <Avatar name={u.profile?.full_name || 'Member'} src={u.profile?.avatar_url} size="md" status="online" />
                  <div>
